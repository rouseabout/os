...
SYSCALL6 (OS_MMAP, sys_mmap, unsigned long, unsigned long, unsigned long, unsigned long, int, unsigned long)
#endif
SYSCALL3 (OS_FCNTL, sys_fcntl, int, int, int)
#if defined(ARCH_i686)
SYSCALL5R(OS_CLONE, sys_clone, unsigned long, unsigned long, int *, unsigned long, int *)
#elif defined(ARCH_x86_64)
SYSCALL5R(OS_CLONE, sys_clone, unsigned long, unsigned long, int *, int *, unsigned long)
#endif
SYSCALL1 (OS_RT_SIGRETURN, sys_rt_sysreturn, unsigned long)
SYSCALL4 (OS_RT_SIGACTION, sys_rt_sigaction, int, const struct sigaction *, struct sigaction *, size_t)
