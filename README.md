...
It has also been tested with various x86 emulators including 86Box (<https://86box.net/>), Bochs (<https://bochs.sourceforge.io/>), PCem (<https://pcem-emulator.co.uk/>), QEMU (<https://www.qemu.org/>), Tiny386 (<https://github.com/hchunhui/tiny386>), TinyEMU (<https://bellard.org/tinyemu/>), v86 (<https://github.com/copy/v86>) and VirtualBox (<https://www.virtualbox.org/>).
